...
values(1,'고소팝콘',5000,1,'15463244796940.jpg','15463244796940.jpg');
insert into goods(g_code, g_name, g_price, g_section, img_origin, img_1)
values(2,'달콤팝콘',5000,1,'15463244213800.jpg','15463244213800.jpg');
insert into goods(g_code, g_name, g_price, g_section, img_origin, img_1)
values(3,'더블치즈팝콘',6000,1,'15463247055100.jpg','15463247055100.jpg');
insert into goods(g_code, g_name, g_price, g_section, img_origin, img_1)
values(4,'탄산음료',2500,2,'15464083668990.jpg','15464083668990.jpg');
insert into goods(g_code, g_name, g_price, g_section, img_origin, img_1)
values(5,'아메리카노(HOT)',3500,2,'15464096039760.jpg','15464096039760.jpg');
insert into goods(g_code, g_name, g_price, g_section, img_origin, img_1)
values(6,'아메리카노(ICE)',4000,2,'15464105893180.jpg','15464105893180.jpg');
insert into goods(g_code, g_name, g_price, g_section, img_origin, img_1)
values(7,'칠리치즈나쵸',4900,3,'15459092398190.jpg','15459092398190.jpg');
insert into goods(g_code, g_name, g_price, g_section, img_origin, img_1)
values(8,'플레인핫도그',4500,3,'15464120856450.jpg','15464120856450.jpg');
insert into goods(g_code, g_name, g_price, g_section, img_origin, img_1)
values(9,'오징어(완제품)',3500,3,'15459089330830.jpg','15459089330830.jpg');
desc faq;
...
commit;
         ...
         insert into cart values(2,1,2,'user1',1000);
         insert into cart values(3,1,3,'user1',1000);
         insert into cart values(4,1,4,'user1',1000);
         insert into history values (1,1,'user1',1,'1000');
commit;
